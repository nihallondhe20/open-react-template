          ...
          <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-slate-500 inline-flex">
              <a
                ...
                rel="noreferrer"
              >
                Visit<span className="hidden sm:inline"> Here</span>
              </a>{' '}
              <span className="italic px-1.5">or</span>{' '}
              <a className="font-medium hover:underline text-emerald-400" href="https://test.worldofai.in/" target="_blank" rel="noreferrer">
                check new version
              </a>
            </div>
